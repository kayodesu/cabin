...
static inline jint arrobj_len(const Object *o)
{
    assert(o != NULL);
...
static inline void* arrobj_data(Object *o)
{
    assert(o != NULL);
    assert(object_is_array(o));
    return o->data;
...
static inline bool arrobj_check_bounds(const Object *o, jint index)
{
    assert(o != NULL);
    assert(object_is_array(o));
...
void arrobj_copy(Object *dst, jint dst_pos,
                 const Object *src, jint src_pos,
                 jint len);
